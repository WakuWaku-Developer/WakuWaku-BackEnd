...
class RestaurantControllerTest {
    ...
    void setUp (final WebApplicationContext context,
        ...
        PlaceEditorialSummary placeEditorialSummary = new PlaceEditorialSummary("\"다양한반주와함께바삭한튀김과수제우동을맛볼수있는아담한식당입니다.\"");

        PlaceReview placeReview = new PlaceReview("\"촉촉한볼따구\"", 3, "\"3주전\"", "\"https://lh3.googleusercontent.com/a-/ALV-UjVoB_ILlpMn32pQwKbd5R99vuCX8mSb5T4rUzTRBBRts8CQolD9=s128-c0x00000000-cc-rp-mo\"", "\"붓카게우동과자루소바주문\\n직원매우친절함.의외로튀김맛있다\\n우동자체는꽤맛있긴하지만이게3시간을기다릴맛인가?이가격값을하는가?하면별점3점인맛\\n웨이팅이아예없고근처에있다면갈만한집이긴한데절대기다려서먹을맛아님!!!!\\n면발이탱글하다는데개인적으로오사카에서먹은다른우동집이오백만배탱글하고맛있었음\\n손님도로컬거의없고대부분외국인임\\n우연히내가그근처를지나가고있는데웨이팅이없다?할때만가십쇼\"", false);
    ...
    void getSimpleInfoRestaurants() throws Exception {
        ...
        mockMvc.perform(RestDocumentationRequestBuilders
                .get(BASE_URL + "?search=" + SEARCH_WORD))
                ...
                .andDo(MockMvcRestDocumentationWrapper.document("get simple info",
                        ResourceSnippetParameters.builder()
                                ...
                                .queryParameters(parameterWithName("search").description("검색어 입력")),
        ...
        mockMvc.perform(RestDocumentationRequestBuilders
                ...
                .andDo(MockMvcRestDocumentationWrapper.document("get details info",
                        ResourceSnippetParameters.builder()
                                ...
                                .pathParameters(parameterWithName("placeId").description("해당 식당의 Place Id")),
                        preprocessRequest(prettyPrint()),
                        preprocessResponse(prettyPrint()),
                        responseFields(
                                fieldWithPath("name").type(JsonFieldType.STRING).description("식당 이름"),
